...
import { UserListHead, UserListToolbar, UserMoreMenu } from '../components_mrk/_dashboard/user';


import { connect } from "react-redux";
import { fetchUserAll } from "../actions/user";
...
//   phoneNumber: faker.phoneNumber.phoneNumberName(),
                ...
                <TableBody>
                  {filteredUsers
                    ...
                    .map((row) => {
                      ...
                      const role = row.role;
                      const status = row.isBlockedByAdmin ? "banned" : "active";
                      const phoneNumber = row.phoneNumber;
                      const avatarUrl = "";
                      const isVerified  = row.isVerifiedByAdmin;;
